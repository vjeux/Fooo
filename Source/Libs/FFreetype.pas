...
//  );
 ...
 FT_Charmap = packed record
  ...
  FT_Glyph_Class_ptr = ^FT_Glyph_Class_;
  FT_Glyph_Class_ = packed record
    glyph_size : FT_Long;
...
{ GLOBAL PROCEDURES }
 ...
 function  FT_Init_FreeType(alibrary : FT_Library_ptr ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Init_FreeType';

 function  FT_Done_FreeType(alibrary : FT_Library_ptr ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Done_FreeType';

 function  FT_Attach_File(face : FT_Face_ptr; filepathname : PChar ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Attach_File';
 ...
 function  FT_New_Memory_Face(
            ...
            file_size ,
            face_index : FT_Long;
            var aface : FT_Face_ptr ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_New_Memory_Face';

 function  FT_New_Face(
            library_ : FT_Library_ptr;
            filepathname : PChar;
            face_index : FT_Long;
            var aface : FT_Face_ptr ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_New_Face';

 function  FT_Done_Face(face : FT_Face_ptr ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Done_Face';

 function  FT_Select_Charmap(face : FT_Face_ptr; encoding : FT_Encoding ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Select_Charmap';

 function  FT_Get_Char_Index(face : FT_Face_ptr; charcode : FT_ULong ) : FT_UInt; cdecl; external 'freetype.dll' name 'FT_Get_Char_Index';

 function  FT_Load_Glyph(
            face : FT_Face_ptr;
            glyph_index : FT_UInt ;
            load_flags : FT_Int32 ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Load_Glyph';

 function  FT_Render_Glyph(slot : FT_GlyphSlot_ptr; render_mode : FT_Render_Mode ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Render_Glyph';

 function  FT_Get_Kerning(
            face : FT_Face_ptr;
            left_glyph ,right_glyph ,kern_mode : FT_UInt;
            akerning : FT_Vector_ptr ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Get_Kerning';

 function  FT_Set_Char_Size(
            face : FT_Face_ptr;
            char_width ,char_height : FT_F26dot6;
            horz_res ,vert_res : FT_UInt) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Set_Char_Size';

 function  FT_Set_Pixel_Sizes(
            face : FT_Face_ptr;
            pixel_width ,pixel_height : FT_UInt ) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Set_Pixel_Sizes';

 function FT_Get_Glyph(slot : FT_GlyphSlot_ptr; var aglyph : FT_Glyph) : FT_Error; cdecl; external 'freetype.dll' name 'FT_Get_Glyph';

 function FT_Glyph_To_Bitmap(the_glyph : FT_Glyph_ptr;
                      render_mode : FT_Render_Mode;
                      origin : FT_Vector_ptr;
                      destroy : FT_Bool) : FT_Error;  cdecl; external 'freetype.dll' name 'FT_Glyph_To_Bitmap';
