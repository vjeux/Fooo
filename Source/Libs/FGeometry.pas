...
function QuaternionLength(q : TQuaternion) : Double;
begin
	Result := Sqrt(
			q.RealPart * q.RealPart
		+ q.ImagPart[0] * q.ImagPart[0]
		+ q.ImagPart[1] * q.ImagPart[1]
		+ q.ImagPart[2] * q.ImagPart[2]
	);
end;
...
var
	l : double;
begin
	l := QuaternionLength(q);
	Result.RealPart := Result.RealPart / l;
	Result.ImagPart[0] := Result.ImagPart[0] / l;
	Result.ImagPart[1] := Result.ImagPart[1] / l;
	Result.ImagPart[2] := Result.ImagPart[2] / l;
end;
